...
sfs_io_nolock(struct sfs_fs *sfs, struct sfs_inode *sin, void *buf, off_t offset, size_t *alenp, bool write) {
  ...
  //LAB8:EXERCISE1 YOUR CODE 2312482 2312364 2312163 HINT: call sfs_bmap_load_nolock, sfs_rbuf, sfs_rblock,etc. read different kind of blocks in file
	/*
	...
	*/
    ...
    // (1) 如果offset不与第一个块对齐，读写从offset到第一个块末尾的内容
    ...
    // (3) 如果结束位置不与最后一个块对齐，读写从开始到(endpos % SFS_BLKSIZE)的内容
