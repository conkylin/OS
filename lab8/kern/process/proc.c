...
int do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf)
{
    ...
    ret = -E_NO_MEM;
    // LAB8:EXERCISE2 YOUR CODE 2312482 2312364 2312163 HINT:how to copy the fs in parent's proc_struct?
    // LAB4:填写你在lab4中实现的代码
    /*
     * Some Useful MACROs, Functions and DEFINEs, you can use them in below implementation.
     * MACROs or Functions:
...
{
    /* LAB8:EXERCISE2 YOUR CODE  2312482 2312364 2312163  HINT:how to load the file with handler fd  in to process's memory? how to setup argc/argv?
     * MACROs or Functions:
    ...
    // (2) 创建新的PDT，mm->pgdir = PDT的内核虚拟地址
    if (setup_pgdir(mm) != 0) {
        goto bad_pgdir_cleanup_mm;
    }
    
    // (3) 从文件中复制TEXT/DATA/BSS段到进程的内存空间
    struct Page *page;
