    ...
    switch (cause) {
        ...
        case IRQ_S_TIMER:
            ...
            // cprintf("Supervisor timer interrupt\n");
             /* LAB3 EXERCISE1   YOUR CODE : 2312482 2312364 2312163 */
...
void exception_handler(struct trapframe *tf) {
    switch (tf->cause) {
        ...
        case CAUSE_ILLEGAL_INSTRUCTION:
             // 非法指令异常处理
             /* LAB3 CHALLENGE3   YOUR CODE : 2312482 2312364 2312163 */
        ...
        case CAUSE_BREAKPOINT:
            //断点异常处理
            /* LAB3 CHALLLENGE3   YOUR CODE : 2312482 2312364 2312163 */
            ...
            */
            ...
            // (3) 更新 tf->epc寄存器，跳过ebreak指令
            // ebreak指令在RISC-V中是4字节
            tf->epc += 4;
            break;
